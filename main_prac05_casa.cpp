...
void display(void)
{
	...
	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(0.0f, 2.75f, 0.0f));
	model = glm::scale(model, glm::vec3(0.5f, 0.5f, 1.0f));
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 0.0f, 0.0f));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24);//cuello

	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(0.0f, 4.25f, 0.0f));
	model = glm::scale(model, glm::vec3(1.5f, 2.5f, 1.0f));
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 0.0f, 0.0f));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24);//cabeza

	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(0.0f, -3.5f, 0.0f));
	...
	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(1.5f, -6.0f, 0.0f));
	model = glm::scale(model, glm::vec3(1.0f, 3.0f, 1.0f));
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 1.0f, 1.0f));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24);//pierna derecho

	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(3.0f, -8.0f, 0.0f));
	...
	//Empieza brazo derecho 
	//hombro
	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(2.0f, 2.0f, 0.0f));

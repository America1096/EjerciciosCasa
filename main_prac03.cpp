...
void myData()
{
	GLfloat vertices[] = {
		//Position				//Color
		-0.5f, -0.5f, 0.5f,		1.0f, 0.0f, 1.0f,	//V0 - Frontal
...
void display(void)
{
	...
	projectionShader.setVec3("myColor", 0.0f, 0.0f, 0.0f);
	...
	model = glm::translate(model, glm::vec3(1.0f, 0.0f, 0.0f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("myColor", 1.0f, 0.0f, 0.0f);
	glDrawArrays(GL_QUADS, 0, 24);
	model = glm::translate(model, glm::vec3(1.0f, 0.0f, 0.0f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("myColor", 1.0f, 0.0f, 0.0f);
	...
	model = glm::translate(model, glm::vec3(1.0f, 0.0f, 0.0f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("myColor", 0.9f, 0.9f, 0.9f);
	glDrawArrays(GL_QUADS, 0, 24);
	model = glm::translate(model, glm::vec3(1.0f, 0.0f, 0.0f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("myColor", 0.9f, 0.9f, 0.9f);
	...
	model = glm::translate(model, glm::vec3(1.0f, 0.0f, 0.0f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("myColor", 1.0f, 1.0f, 1.0f);
	glDrawArrays(GL_QUADS, 0, 24);
	model = glm::translate(model, glm::vec3(1.0f, 0.0f, 0.0f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("myColor", 1.0f, 1.0f, 1.0f);
	...
	model = glm::translate(model, glm::vec3(1.0f, 0.0f, 0.0f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("myColor", 0.7f, 0.7f, 0.7f);
	glDrawArrays(GL_QUADS, 0, 24);
	model = glm::translate(model, glm::vec3(1.0f, 0.0f, 0.0f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("myColor", 0.0f, 0.0f, 0.0f);
